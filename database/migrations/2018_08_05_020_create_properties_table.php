...
class CreatePropertiesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('properties', function (Blueprint $table) {
            ...
            $table->json('galleries');//id de galerías de imágenes asociadas a la propiedad.
            $table->json('features')->nullable();//Características internas y externas asociadas a la propiedad.  
            $table->timestamps();
        });
    }
