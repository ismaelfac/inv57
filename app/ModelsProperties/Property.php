        ...
        try {
            for ($i = 0; $i < $length_properties - 2; $i++) {
                ...
                $properties = Property::create([
                    ...
                    'property_type_id' => $propertiesWasi[$i]['id_property_type'],
                    'country_id' => 45,
                    ...
                    'neighborhood_id' => Neighborhood::getNeighborhoodforWasiAttribute($propertiesWasi[$i]['zone_label']),
                    'location_id' => Location::getLocationforAttribute('neighborhood_id'),
