<script src="{{ asset("admin2/vendor/jquery/jquery.min.js") }}"></script>
    ...
    <script src="{{ asset("admin2/vendor/datatables/jquery.dataTables.js") }}"></script>
    <script src="{{ asset("admin2/vendor/datatables/dataTables.bootstrap4.js") }}"></script>

    <!-- Custom scripts for all pages-->
    <script src="{{ asset("admin2/js/sb-admin.min.js") }}"></script>
